...
class CartItem:
    ...
    def cart_item_price(self):
        ...
        cart_item_price = 0.0
        # if bulk price discounts are available for the product then we calculate as per the special price offer
        if discounted_bulk_quantities:
            ...
            # we will try to group it together for each special price
        ...
        # we will calculate the price of the remaining quantity left after including special price offer
